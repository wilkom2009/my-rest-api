...
<div class="container">
	...
	<form:form class="form-horizontal" method="post" modelAttribute="update" action="${postActionUrl}">
		...
		<div class="form-group">
			...
			<button type="submit" class="btn-lg btn-primary pull-right">Modifier</button>
			</div>
		</div>
	</form:form>
